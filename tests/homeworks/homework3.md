...
This homework is to be completed **before** the short course given on October 21.

Purpose: assess and analyze data from GNSS station ROSS to learn how to measure water level.
...
Find ROSS and click on it. If you scroll down, you will see a photo of the monument. 


Next, let's get an idea of what this site looks like from a reflections viewpoint. Use the geoid tab on the [webapp](https://gnss-reflections.org/geoid) to
...
Although the elevation of the site is ~186 meters above sea level, clearly from the photo you looked at that is not the value 
...
Use the [reflection zone section of the web app](https://gnss-reflections.org/rzones). Set a Reflector Height (RH) value and see what 
comes back. You don't want your reflection zones to cross a dock or the nearby boats, so rerun it with azimuth limits.  
...
Let's make a SNR file using **rinex2snr**
